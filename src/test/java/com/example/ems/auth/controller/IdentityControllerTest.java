...
public class IdentityControllerTest {
    ...
    public void testGetUserProfile() throws Exception {
        BootstrapResponse.UserProfileResponse mockProfile = new BootstrapResponse.UserProfileResponse(
                1L, "EMP001", "Test User", "test@company.com", "EMPLOYEE", "https://avatar.url", false, false, "ACTIVE", "now"
        );
    ...
    public void testGetBootstrapData() throws Exception {
        ...
        BootstrapResponse.AuthDataResponse mockAuth = new BootstrapResponse.AuthDataResponse(Collections.singletonList("attendance.read"));
    ...
    public void testGetPermissions() throws Exception {
        when(roleService.getPermissionsForUserId("EMP001")).thenReturn(Collections.singletonList("attendance.read"));
