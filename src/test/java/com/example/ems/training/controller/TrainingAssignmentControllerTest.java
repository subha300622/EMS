...
public class TrainingAssignmentControllerTest {
        ...
        public void testUpdateProgressSuccess() throws Exception {
                ...
                when(assignmentService.updateProgress(eq(9001L), any(TrainingProgressUpdateRequest.class)))
                                .thenReturn(respMap);
        ...
        public void testGetTeamProgressSuccess() throws Exception {
                ...
                Map<String, Object> progMap = Map.of("content", List.of(
                                Map.of("employeeId", 201, "employeeName", "Arjun Mehta", "totalAssigned", 3, "risk",
                                                false)));
        ...
        public void testGetEmployeeDetailSuccess() throws Exception {
                ...
                EmployeeTrainingDetailResponse details = new EmployeeTrainingDetailResponse(
                                203L, "Dev Patel",
                                List.of(new EmployeeTrainingDetailResponse.CourseProgressDto("Git CI/CD", "OVERDUE", 0,
                                                LocalDate.of(2026, 6, 10))),
                                List.of(new EmployeeTrainingDetailResponse.CertificationDto("Git Basics",
