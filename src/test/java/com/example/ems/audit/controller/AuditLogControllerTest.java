...
public class AuditLogControllerTest {
        ...
        public void testGetAllLogsSuccess() throws Exception {
                ...
                AuditLog log = new AuditLog("EMP001", "emp@example.com", "CREATE_EMPLOYEE", "Employee", "1",
                                "127.0.0.1",
                                "Created John");
        ...
        public void testGetLogByIdSuccess() throws Exception {
                mockPermission("audit.read", true);
                AuditLog log = new AuditLog("EMP001", "emp@example.com", "UPDATE_EMPLOYEE", "Employee", "1",
                                "127.0.0.1",
                                "Updated John");
        ...
        public void testExportLogsSuccess() throws Exception {
                ...
                when(auditLogService.exportLogsToCsv(any())).thenReturn(csvData);
        ...
        public void testGetDashboardStatsSuccess() throws Exception {
                mockPermission("audit.read", true);
                when(auditLogService.getDashboardStats(any()))
                                .thenReturn(new AuditDashboardStatsDto(0, 5L, 0, 0));
        ...
        public void testReviewLogSuccess() throws Exception {
                ...
                AuditLog log = new AuditLog("EMP001", "emp@example.com", "UPDATE_EMPLOYEE", "Employee", "1",
                                "127.0.0.1",
                                "Updated John");
                when(auditLogService.reviewLog(eq(1L), anyString(), any()))
                                .thenReturn(log);

                mockMvc.perform(
                                post("/api/v1/audit-logs/1/review")
                                                .header("Authorization", AUTH_HEADER)
        ...
        public void testDismissAllFlagsSuccess() throws Exception {
                ...
                mockMvc.perform(post("/api/v1/audit-logs/dismiss-all")
                                .header("Authorization", AUTH_HEADER))
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.success").value(true));
        }
        ...
        public void testGetLogsByUserSuccess() throws Exception {
                mockPermission("audit.read", true);
                AuditLog log = new AuditLog("EMP002", "emp2@example.com", "LOGIN", "User", "EMP002", "127.0.0.1",
                                "Logged in");
