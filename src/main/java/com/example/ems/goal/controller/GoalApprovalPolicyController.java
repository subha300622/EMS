...
public class GoalApprovalPolicyController {
    ...
    public ResponseEntity<ApiResponse<List<GoalApprovalPolicy>>> getPolicies(@RequestParam(value = "module", required = false) String module) {
    ...
    public ResponseEntity<ApiResponse<GoalApprovalPolicy>> createPolicy(@Valid @RequestBody GoalApprovalPolicyRequest request) {
    ...
    @PreAuthorize("hasAuthority('GOAL_CONFIG_EDIT') or hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<GoalApprovalPolicy>> updatePolicy(
    ...
    @PreAuthorize("hasAuthority('GOAL_CONFIG_EDIT') or hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Void>> deletePolicy(@PathVariable("policyId") Long policyId) {
