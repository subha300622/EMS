...
public interface AppraisalHistoryRepository extends JpaRepository<AppraisalHistory, Long> {
    ...
    List<AppraisalHistory> findByAppraisalIdOrderByChangedAtDesc(Long appraisalId);
    List<AppraisalHistory> findByOrganizationIdAndEmployeeIdOrderByChangedAtDesc(Long organizationId, Long employeeId);
}
