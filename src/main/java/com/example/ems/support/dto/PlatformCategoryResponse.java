...
@Schema(description = "Platform Support Category Detail Response")
public class PlatformCategoryResponse {
    ...
    @Schema(description = "Creation timestamp", example = "2026-09-25T11:30:00+05:30")
    private String createdAt;

    @Schema(description = "Last update timestamp", example = "2026-09-25T11:30:00+05:30")
    private String updatedAt;

    public PlatformCategoryResponse() {}

    public PlatformCategoryResponse(Long id, String name, String description, String status,
