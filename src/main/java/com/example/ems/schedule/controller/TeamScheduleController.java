...
public class TeamScheduleController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<TeamScheduleResponse>> getTeamSchedule(
        ...
        if (!checkReadPermission(user)) {
            return ResponseEntity.status(HttpStatus.FORBIDDEN)
                    .body(ApiResponse.error("Access Denied: Requires read permission", "AUTH_002"));
        }
    ...
    public ResponseEntity<ApiResponse<Void>> assignShift(
        ...
        if (!checkWritePermission(user)) {
            return ResponseEntity.status(HttpStatus.FORBIDDEN)
                    .body(ApiResponse.error("Access Denied: Requires write permission", "AUTH_002"));
        }
    ...
    public ResponseEntity<ApiResponse<Void>> approveSwap(
            @RequestHeader("Authorization") String authHeader,
    ...
    public ResponseEntity<ApiResponse<Void>> rejectSwap(
            @RequestHeader("Authorization") String authHeader,
            @PathVariable Long id) {
