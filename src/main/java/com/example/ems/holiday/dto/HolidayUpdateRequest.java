...
@Schema(description = "Request payload for updating an organization holiday")
public class HolidayUpdateRequest {

    @Schema(description = "Name of the holiday", example = "Christmas Day (Observed)", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Optional description or notes for the holiday", example = "Updated holiday celebration")
