...
@Schema(description = "Query parameters for filtering Department Attendance history")
public class DepartmentAttendanceHistoryQuery {
    ...
    public DepartmentAttendanceHistoryQuery() {}
