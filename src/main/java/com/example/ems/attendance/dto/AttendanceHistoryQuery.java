...
@Schema(description = "Query parameters for filtering attendance history")
public class AttendanceHistoryQuery {
    ...
    public Pageable toPageable() {
        String safeSortField = (sortBy != null && ALLOWED_SORT_FIELDS.contains(sortBy)) ? sortBy : DEFAULT_SORT_FIELD;
