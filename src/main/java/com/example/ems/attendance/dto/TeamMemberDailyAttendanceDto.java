...
@Schema(description = "Team Member Daily Attendance Detail")
public class TeamMemberDailyAttendanceDto {
    ...
    @Schema(description = "Whether this employee is the team lead", example = "false")
    private Boolean isTeamLead = false;

    @Schema(description = "Daily attendance status (PRESENT, ABSENT, ON_LEAVE, WORKING, ON_BREAK, COMPLETED, NOT_CHECKED_IN, etc.)", example = "PRESENT")
    ...
    public TeamMemberDailyAttendanceDto() {}
