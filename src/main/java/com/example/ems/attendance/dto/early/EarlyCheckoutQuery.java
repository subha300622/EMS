...
@Schema(description = "Query parameters for filtering Early Checkout report")
public class EarlyCheckoutQuery {

    private static final Set<String> ALLOWED_SORT_FIELDS = Set.of("date", "checkOutTime", "status", "earlyByMinutes");
