...
public class SwaggerConfig {
        ...
        public OpenAPI customOpenAPI() {
                ...
                final String orgHeaderSchemeName = "organizationId";
                return new OpenAPI()
                                ...
                                .components(new Components()
                                                .addSecuritySchemes(securitySchemeName,
                                                                new SecurityScheme()
                                                                                ...
                                                                                .scheme("bearer")
                                                                                .bearerFormat("JWT"))
                                                .addSecuritySchemes(orgHeaderSchemeName,
                                                                new SecurityScheme()
                                ...
                                .tags(List.of(
                                                ...
                                                new Tag().name("Department Management")
                                                                .description("Departments, department managers, budgets, and departmental structure."),
                                                new Tag().name("Organization Directory").description(
                                                                "Employee directory, organization charts, lookup and reporting hierarchies."),
                                                new Tag().name("Employee Directory")
                                                ...
                                                new Tag().name("Notification Management")
                                                                .description("System notification templates, logs, and user notifications."),
        ...
        private OpenApiCustomizer filterByTagsCustomizer(Set<String> allowedTags, List<String> excludes,
                ...
                return openApi -> {
                        ...
                        // Filter the OpenAPI tags list to only contain the allowed tags that are
                        // actually used
