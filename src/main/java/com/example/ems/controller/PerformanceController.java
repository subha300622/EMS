...
public class PerformanceController {
    ...
    // ── 1. DASHBOARD ─────────────────────────────────────────────────────────
    @GetMapping("/performances/dashboard")
    ...
    // ── 2. CYCLES ────────────────────────────────────────────────────────────
    @GetMapping("/performances/cycles")
    ...
    @PostMapping("/performances/cycles")
    ...
    @PutMapping("/performances/cycles/{id}")
    ...
    @PostMapping("/performances/goals")
    ...
    @PatchMapping("/performances/goals/{id}/progress")
    ...
    @DeleteMapping("/performances/goals/{id}")
    ...
    // ── 4. SELF-REVIEWS ──────────────────────────────────────────────────────
    @PostMapping("/performances/self-reviews")
    ...
    // ── 5. MANAGER REVIEWS ───────────────────────────────────────────────────
    @PostMapping("/performances/manager-reviews")
    ...
    // ── 6. FEEDBACKS ─────────────────────────────────────────────────────────
    @GetMapping("/performances/feedbacks")
    ...
    // ── 7. FINALIZE REVIEW ───────────────────────────────────────────────────
    @PostMapping("/performances/reviews/{id}/finalize")
    ...
    // ── 9. REPORTS ───────────────────────────────────────────────────────────
    @GetMapping("/performances/reports/{reportType}")
    ...
    // ── 10. NOTIFICATIONS ─────────────────────────────────────────────────────
    @PostMapping("/performances/notifications")
