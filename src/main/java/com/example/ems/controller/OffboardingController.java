...
public class OffboardingController {
    ...
    // ── 1. GET DASHBOARD ────────────────────────────────────────────────────
    @GetMapping("/offboardings/dashboard")
    ...
    @PatchMapping("/offboardings/{id}/approve")
    ...
    // ── 6. GET TASKS ────────────────────────────────────────────────────────
    @GetMapping("/offboardings/{id}/tasks")
    ...
    @PatchMapping("/offboardings/tasks/{taskId}/status")
    ...
    // ── 7. RETURN ASSET ─────────────────────────────────────────────────────
    @PostMapping("/offboardings/assets/return")
    ...
    // ── 8. SETTLEMENT ────────────────────────────────────────────────────────
    @PostMapping("/offboardings/{id}/settlement")
    ...
    @PatchMapping("/offboardings/{id}/complete")
    ...
    @PatchMapping("/offboardings/{id}/reject")
    ...
    // ── 10. HANDOVER ────────────────────────────────────────────────────────
    @PostMapping("/offboardings/handover")
    ...
    // ── 11. EXIT INTERVIEWS ─────────────────────────────────────────────────
    @PostMapping("/offboardings/exit-interviews")
    ...
    @PostMapping("/offboardings/exit-interviews/{id}/feedback")
    ...
    // ── 12. REVOKE ACCESS ───────────────────────────────────────────────────
    @PostMapping("/offboardings/{id}/revoke-access")
    ...
    @GetMapping("/offboardings/reports/{reportType}")
    ...
    @GetMapping("/offboardings/analytics")
